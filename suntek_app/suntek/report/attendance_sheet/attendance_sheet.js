...
frappe.query_reports["Greentek Monthly Attendance Sheet"] = {
	"filters": [
  	...
  	"default": function() {
  		...
  		let currentMonth = parseInt(today.split('-')[1]);
  		...
  		let fromDate = `${year}-${previousMonth < 10 ? '0' + previousMonth : previousMonth}-26`;
  		return fromDate;
	}
},
{
	...
	"default": function() {
		...
		let toDate = `${year}-${currentMonth}-25`;
		return toDate;
	}
},
