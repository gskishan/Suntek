...
def execute():
    ...
    cf_count = frappe.db.sql("SELECT COUNT(*) FROM `tabCustom Field` WHERE module = 'suntek'")[0][0]
    ps_count = frappe.db.sql("SELECT COUNT(*) FROM `tabProperty Setter` WHERE module = 'suntek'")[0][0]
